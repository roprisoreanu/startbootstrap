...
<html lang="ro">
   <?php 
	   $cssType = "parcuri-fotovoltaice.css"; 
	   $htmlTitle = "Montare parc panouri solare fotovoltaice";
	   $htmlDescription = "Unimat - furnizare si montare panouri solare fotovoltaice, 
    					   proiect tehnic de executie si confectii metalice";
  ...
  <body>
	  ...
	  <!-- <script>
		...
		ga('create', 'UA-42129390-1', 'uexpert.ro');
		ga('send', 'pageview');
	   </script>  -->
